    ...
    stage('clone') {
      steps {
        ...
        withCredentials([usernamePassword(credentialsId: '64c4d161-f7f3-45e7-8562-71ea1b28b26d', passwordVariable: 'GIT_PASSWORD', usernameVariable: 'GIT_USERNAME')]) {
          sh('rm -rf  ./*')
          sh('pwd')
          sh('git clone https://${GIT_USERNAME}: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@github.com/pilipyukaaa/second.git')
        }
      }
    }
    }
    ...
    stage('push') {
      steps {
        withCredentials([usernamePassword(credentialsId: '64c4d161-f7f3-45e7-8562-71ea1b28b26d', passwordVariable: 'GIT_PASSWORD', usernameVariable: 'GIT_USERNAME')]) {
          ...
          sh('cd src/second; git push https://${GIT_USERNAME}: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@github.com/pilipyukaaa/second.git')
        }
      }
    }
  }
