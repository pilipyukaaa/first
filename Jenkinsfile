...
withCredentials([usernamePassword(credentialsId: '64c4d161-f7f3-45e7-8562-71ea1b28b26d', passwordVariable: 'GIT_PASSWORD', usernameVariable: 'GIT_USERNAME')]) {
    sh('git clone https://${GIT_USERNAME}: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@github.com@github.com/pilipyukaaa/second.git')
}
}
