    ...
    stage('push') {
      steps {
        withCredentials([usernamePassword(credentialsId: '64c4d161-f7f3-45e7-8562-71ea1b28b26d', passwordVariable: 'GIT_PASSWORD', usernameVariable: 'GIT_USERNAME')]) {
          ...
          sh('cd src/second; git push https://${GIT_USERNAME}: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@github.com/pilipyukaaa/second.git --tags')
        }
      }
    }
  }
